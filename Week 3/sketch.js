...
function draw() {
  ...
  if (player == 1) { //If it's player 1's turn then the backdrop turns red
    background(184, 0, 0); //Red
  } else { //If it's anything other than player 1's turn then it's blue
    background(0, 51, 184); //Blue
  }
  ...
  if (winnerPlayer == 0) {
    if (player == 1) {
      fill(255);
      strokeWeight(5);
      rect(vak1X + 50, vak1Y - 55, 200, 40, 10);
      fill(0);
      text("Player 1's Turn!", 110, 50);
    } else {
      fill(255);
      strokeWeight(5);
      rect(vak1X + 50, vak1Y - 55, 200, 40, 10);
      fill(0);
      text("Player 2's Turn!", 110, 50);
  ...
  {
    // if (winnerPlayer == 3 ) { //Tells my program theres no winner
      winnerPlayer = 3;  
      fill(255);
      strokeWeight(5);
      rect(vak1X + 10, vak1Y - 70, 200, 40, 10);
      fill(0, 126, 50);
      textSize(30);
  ...
  if (winnerPlayer > 0) {
    if (winnerPlayer == 1) {
      fill(255);
      strokeWeight(5);
      rect(vak1X + 10, vak1Y - 70, 270, 40, 10);
      fill(0, 126, 50);
      textSize(30);
